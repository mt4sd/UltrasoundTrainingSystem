...
class SimulatorGuidelet(object):
  ...
  def setupViewerLayouts(self):
    self.viewSelectorComboBox.addItem(self.VIEW_US_SIMULATOR_TRAINING)
  ...
  def registerCustomLayouts(self):#common
    ...
    self.one2Ddual3dCustomLayoutId=525
    layoutLogic.GetLayoutNode().AddLayoutDescription(self.one2Ddual3dCustomLayoutId, customLayout)
  ...
  def onViewSelect(self, layoutIndex):
    ...
    if text == self.VIEW_US_SIMULATOR_TRAINING:
